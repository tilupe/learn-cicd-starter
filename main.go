...
func main() {
    ...
    ReadTimeout:       10 * time.Second,   // Optional but recommended
    WriteTimeout:      10 * time.Second,   // Optional but recommended
    IdleTimeout:       120 * time.Second,  // Optional but recommended
	}
